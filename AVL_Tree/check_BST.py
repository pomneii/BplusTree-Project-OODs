...
def check_binary_search_tree_(root, minVal = 0, maxVal = 100):
    if root == None :
        return True  
    ...
    return (check_binary_search_tree_(root.left, minVal, root.data - 1) and
            check_binary_search_tree_(root.right, root.data + 1, maxVal) )
