...
def add_room_manual():
    room_number_add = int(input("Enter room number : "))
    if search_room(room_number_add) :
        return
    else :
        bplustree.show()
        # bplustree.insert(room_number_add, room_number_add)  
        bplustree[room_number_add] = room_number_add 
        bplustree.show()
...
def remove_room_manual():
    ...
    if not search_room(room_number_remove) :
        print (f"Room {room_number_remove} does not exist in the tree.")
        return
    else :
        bplustree.show()
